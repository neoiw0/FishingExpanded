...
internal class CollectionsPagePatches
{
	...
	public static void Draw_Postfix(SpriteBatch b, ClickableTextureComponent __instance, float layerDepth)
	{
		...
		try
		{
			...
			{
				b.Draw(Game1.mouseCursors, new Vector2((float)(((ClickableComponent)__instance).bounds.X + 3), (float)(((ClickableComponent)__instance).bounds.Y + 3)), (Rectangle?)new Rectangle(280, 188, 94, 84), Color.White, 0f, Vector2.Zero, 0.25531915f, (SpriteEffects)0, layerDepth + 0.01f);
				return;
			}
