...
**最后更新**: 2026-08-05（接管整理）  
**验收候选**: 历史记录为 v0.5.2  
**当前状态**: 静态实现、构建和部署有历史记录；9项玩家验收仍待独立完成。当前维护入口为 `MAINTENANCE-INDEX.md` 和 `BUG-LEDGER.md`。

> 注意：`Source\manifest.json` 当前为 `0.5.10`，`FishingExpanded.csproj` 当前为 `0.1.0`，与历史 v0.5.2 记录不一致；版本事实未统一前不视为正式发布版本。
...
- 五只鱼王不接受难度、数量、品质、奖励、技能、称号、视觉和 NPC 修改，但仍使用统一的全局蓄力槽保护。
