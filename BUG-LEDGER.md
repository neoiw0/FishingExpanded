...
- 历史 v0.5.2 记录包含旧构建/部署事实；当前 `0.5.10` 已完成静态构建和部署，但玩家验收仍未完成；每个现象必须独立标记通过、失败或未执行。
...
| BATCH-024 | 多人数据与鱼获生命周期修正 | ✅ R1完成，待R2 | 2026-08-05 | ✅ | ✅ | ⏳ | ✅ | ✅ | ⏳ |

---

## BATCH-024：多人数据与鱼获生命周期修正 ✅ Release 0.5.10 构建/部署完成，待实测
...
**构建**：✅ `Source\FishingExpanded.csproj` Release Rebuild，0警告，0错误；版本 `0.5.10`
**部署**：✅ `D:\GGGGG\K1515\Mods\FishingExpanded`；DLL、依赖和 manifest 与 Release 输出哈希一致；最终 DLL SHA-256 为 `13B3391F52D2E4B8F5EB739C28779D36698B44A7BCB993D9BE7870780CA3FCE1`；备份见 `DeploymentBackups\FishingExpanded-20260805-183148`
**实测**：待多人和原生溢出验收
